...
static void n10_power_init(struct power_module *module)
{
	/* init the vatiables */
...
static void n10_power_set_interactive(struct power_module *module, int on)
{
...
static void n10_power_hint(struct power_module *module, power_hint_t hint,
                            void *data)
{
    switch (hint) {
...
struct power_module HAL_MODULE_INFO_SYM = {
    ...
    .init = n10_power_init,
    .setInteractive = n10_power_set_interactive,
    .powerHint = n10_power_hint,
};
