/*
 * arch/arm/mach-tegra/board-n10-nand.c
 *
...
static struct tegra_nand_chip_parms n10_nand_chip_parms[] = {
	/* Samsung K5E2G1GACM */
	[0] = {
		.vendor_id   = 0xEC,
		.device_id   = 0xAA,
...
static struct mtd_partition n10_nand_partitions[] = {
	[0] = {
		.name		= "misc",
		.offset		=  6784*1024,
		.size		=  2048*1024,
...
static struct tegra_nand_platform n10_nand_data = {
	.max_chips	= 8,
	.chip_parms	= n10_nand_chip_parms,
	.nr_chip_parms  = ARRAY_SIZE(n10_nand_chip_parms),
	.parts		= n10_nand_partitions,
	.nr_parts	= ARRAY_SIZE(n10_nand_partitions),
	.wp_gpio	= -1,
};
...
struct platform_device tegra_nand_device = {
	...
	.dev            = {
		.platform_data = &n10_nand_data,
	},
};

int __init n10_nand_register_devices(void)
{
