...
static int sensor_set_mode(struct sensor_info *info, int xres, int yres)
{
	...
	if (!(val == SENSOR_1600_WIDTH_VAL || 
		 val == SENSOR_1280_WIDTH_VAL || 
		 val == SENSOR_800_WIDTH_VAL || 
		 val == SENSOR_640_WIDTH_VAL) && 
			sensor_table == SENSOR_MODE_1600x1200) {
		...
		if (!((val == SENSOR_640_WIDTH_VAL && sensor_table == SENSOR_MODE_640x480)
			||(val == SENSOR_800_WIDTH_VAL && sensor_table == SENSOR_MODE_800x600)
